...
Instead of using prebuilt implementations like Hugging Face, I implemented the GPT-2 architecture from the ground up, carefully reproducing its internal structure. After building the model, I loaded pretrained GPT-2 weights and fine-tuned it on an Alpaca-style instruction dataset to create a conversational chatbot.
...
✅ The architecture matches GPT-2 Medium to ensure seamless pretrained weight loading.
...
* Manually mapped parameter names
* Verified tensor shapes
* Validated forward pass outputs

✅ Ensured full compatibility with pretrained GPT-2.
...
🎯 Goal: Generate helpful, instruction-following responses.
