...
Instead of using HuggingFace’s ready-made model, I implemented the GPT-2 architecture from scratch — carefully matching the original structure — then loaded pretrained GPT-2 weights and fine-tuned the model on an Alpaca-style instruction dataset to make it conversational.
